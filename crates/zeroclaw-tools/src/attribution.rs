...
use crate::cdp_browser::CdpBrowserTool;
...
use crate::codebase_snapshot::CodebaseSnapshotTool;
...
use crate::fs_event_monitor::FsEventMonitorTool;
use crate::gemini_cli::GeminiCliTool;
use crate::git_native::GitNativeTool;
...
use crate::os_input::OSInputTool;
...
use crate::sys_info::SysInfoTool;
...
use crate::web_parse::WebParseTool;
...
tool_attribution!(OSInputTool, ToolKind::Plugin);
tool_attribution!(CdpBrowserTool, ToolKind::Plugin);
tool_attribution!(SysInfoTool, ToolKind::Plugin);
tool_attribution!(WebParseTool, ToolKind::Plugin);
tool_attribution!(GitNativeTool, ToolKind::Plugin);
tool_attribution!(FsEventMonitorTool, ToolKind::Plugin);
tool_attribution!(CodebaseSnapshotTool, ToolKind::Search);
